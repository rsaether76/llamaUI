...
def _build_default_catalog() -> LlamaOptionCatalog:
    opts: List[LlamaOption] = [
        ...
        _opt("split_mode", "--split-mode", OptionKind.STRING, "GPU / offload", "Split mode", "How to split tensors across GPUs: none, layer, row, tensor.", default=LlamaOptionValue.from_raw(OptionKind.STRING, "layer"), restart_required=True, enum_values=(("none","none"), ("layer","layer"), ("row","row"), ("tensor","tensor"))),
